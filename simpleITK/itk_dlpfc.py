...
import os
root = "/mnt/data/registration"
datalist = "imglist/dlpfc_imglist/center_align_test.txt"
datapath = os.path.join(root, datalist)
f = open(datapath, 'r')
lines = f.readlines()
prefix=['0_0','0_1','0_2','1_0','1_1','1_2','2_0','2_1','2_2']
for i in range(len(lines)):
    ...
    #
    np.savez("/mnt/data/registration/result/center_align/DLPFC/simpleitk/" + prefix[i] + "_result", pts1=fixed_pts,pts2=warped_pts,img1=fixed_image,img2=warped_image,label1=fixed_label,label2=moving_label)
    np.savez("/mnt/data/registration/result/center_align/DLPFC/initial/" + prefix[i] + "_result", pts1=fixed_pts, pts2=moving_pts,img1=fixed_image, img2=moving_image, label1=fixed_label, label2=moving_label)
