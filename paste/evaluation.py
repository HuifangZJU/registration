...
print('Unaligned')
average_results = evaluate_multiple_pairs("/media/huifang/data/registration/result/pairwise_align/original/DLPFC/paste/",keys,"orig")
print('SimpleITK')
average_results = evaluate_multiple_pairs("/media/huifang/data/registration/result/pairwise_align/simpleITK/DLPFC/marker_free/",keys,"vispro_itk")
...
print('PASTE')
average_results = evaluate_multiple_pairs("/media/huifang/data/registration/result/pairwise_align/PASTE/DLPFC/",keys,'paste')
print('Ours')
