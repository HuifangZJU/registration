...
datalist = "imglist/breast_imglist/test.txt"
...
for i in range(len(lines)):
    ...
    #
    np.savez("/media/huifang/data/registration/result/xenium/breast/simpleitk/" + prefix[i] + "_result", pts1=fixed_pts,pts2=warped_pts,img1=fixed_image,img2=warped_image,label1=fixed_label,label2=moving_label)
    np.savez("/media/huifang/data/registration/result/xenium/breast/initial/" + prefix[i] + "_result", pts1=fixed_pts, pts2=moving_pts,img1=fixed_image, img2=moving_image, label1=fixed_label, label2=moving_label)
