...
for k, slices in patients.items():
    ...
    for i, data_slice in enumerate(gene_data_list):
        ...
        feature_matrix = get_gene_feature_matrix(coords, reduced_slice_data, (1024, 1024), patch_size=32)
        ...
        # plt.imsave("../data/SCC/huifang/" + str(k) + "_" + str(i) + "_image.png", image)
        # np.save("../data/SCC/huifang/" + str(k) + "_" + str(i) + "_pca_out.npy", feature_matrix)
        # np.savez("../data/SCC/huifang/" + str(k) + "_" + str(i) + "_validation", coord=coords, label=labels)
        # plot_dimensional_images_side_by_side(feature_matrix)
